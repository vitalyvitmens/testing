...
//! toHaveBeenCalled() - проверка запуска вызова функции
//! toHaveBeenCalledTimes() - ожидаем, что мок-функция fn будет вызвана ровно один раз
//! toHaveBeenCalledWith() - ожидаем, что мок-функция fn будет вызвана с аргументом 
//! toHaveBeenLastCalledWith() - ожидаем, что мок-функция fn последний раз была вызвана с аргументом
//! toHaveReturned() - мэтчер проверяющий результат, с каким результатом вернулась функция
//! toHaveReturnedTimes() - мэтчер проверяющий сколько раз функция завершилась
//! toHaveReturnedWith() - мэтчер проверяющий результат, с каким результатом вернулась функция
//! toHaveLastReturnedWith() - мэтчер проверяющий результат, с каким результатом вернулась функция последний раз
//! toHaveBeenNthCalledWith() - мэтчер проверяющий результат, с каким результатом вернулась функция в определенном количестве вызовов
//! toHaveNthReturnedWith() - мэтчер проверяющий результат, с каким результатом вернулась функция в определенном количестве вызовов
